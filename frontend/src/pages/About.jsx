...
const About = () => {
  return (
    <>
      <div className="pt-16 px-4 sm:px-8 md:px-16 lg:px-16">
        <div className="bg-white rounded-md flex flex-col lg:flex-row items-center lg:items-start gap-10 p-4 relative">
          
          {/* Left Section: Image */}
          <div className="relative w-full lg:w-1/2">
            <div className="bg-teal-300 rounded-tl-[100px] rounded-br-[100px] overflow-hidden p-2">
              <img
                src={aboutimg}
                alt="Fashion"
            ...
            {/* Quote Box */}
            <div className="absolute left-1/2 transform -translate-x-1/2 lg:left-10 lg:translate-x-0 bottom-4 w-11/12 sm:w-80 bg-white shadow-lg p-4 rounded-lg">
              <FaQuoteLeft className="text-teal-500 text-xl -mt-2 mx-auto lg:mx-0" />
              <p className="text-sm text-gray-700 font-medium text-center lg:text-left mt-2">
          ...
          <div className="w-full lg:w-1/2">
            <h4 className="text-teal-500 font-semibold text-lg">Unveiling Our Journey</h4>
            <h2 className="text-gray-900 font-bold text-2xl sm:text-3xl md:text-4xl mt-2">
